...
public class GameBoard extends JPanel {
    ...
    public void InitPiece(){
        try{
            ...
            pieces[0] = new Sun("blue", true, "./images/blue_sun.png");
            pieces[1] = new Chevron("blue", true, "./images/blue_chevron.png");
            pieces[2] = new Triangle("blue", true, "./images/blue_triangle.png");
            pieces[3] = new Plus("blue", true, "./images/blue_plus.png");
            pieces[4] = new Arrow("blue", true, "./images/blue_arrow.png");

            //-------------------------Initializing the red pieces-----------------------------//

            pieces[5] = new Sun("red", true, "./images/red_sun.png");
            pieces[6] = new Chevron("red", true, "./images/red_chevron.png");
            pieces[7] = new Triangle("red", true, "./images/red_triangle.png");
            pieces[8] = new Plus("red", true,"./images/red_plus.png");
            pieces[9] = new Arrow("red", true, "./images/red_arrow.png");
