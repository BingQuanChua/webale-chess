...
public class GameBoard extends JPanel{
    ...
    */
    ...
    //         pieces[0] = new Sun(false, "./images/blue_sun.png", "./images/blue_sun_rotated.png");
    //         pieces[1] = new Chevron(false, "./images/blue_chevron.png", "./images/blue_chevron_rotated.png");
    //         pieces[2] = new Triangle(false, "./images/blue_triangle.png", "./images/blue_triangle_rotated.png");
    //         pieces[3] = new Plus(false, "./images/blue_plus.png", "./images/blue_plus_rotated.png");
    //         pieces[4] = new Arrow(false, "./images/blue_arrow.png", "./images/blue_arrow_rotated.png");

    //         //-------------------------Initializing the red pieces-----------------------------//

    //         pieces[5] = new Sun(true, "./images/red_sun.png", "./images/red_sun_rotated.png");
    //         pieces[6] = new Chevron(true, "./images/red_chevron.png", "./images/red_chevron_rotated.png");
    //         pieces[7] = new Triangle(true, "./images/red_triangle.png", "./images/red_triangle_rotated.png");
    //         pieces[8] = new Plus(true,"./images/red_plus.png","./images/red_plus_rotated.png");
    //         pieces[9] = new Arrow(true, "./images/red_arrow.png", "./images/red_arrow_rotated.png");
